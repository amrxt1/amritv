    ...
    <>
      <Container className="fixed top-0 z-50 w-full py-3">
        ...
        <nav className="flex justify-center">
          <div className="text-text shadow-surface flex min-w-[40%] justify-center gap-4 rounded-full border border-white/30 bg-black/5 px-8 py-1 shadow-inner backdrop-blur-[3px]">
            {navLinks.map((l, i) => (
              <Link
                href={l.href}
                key={i}
